          ...
          <div className="relative h-full w-full">
            <Image
              ...
              onError={(e) => {
                ...
                console.warn('Banner image failed to load, using fallback:', banner.title)
                e.target.src = 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1200&h=600&fit=crop&crop=center'
              }}
            />
            {/* Gradient Overlay */}
