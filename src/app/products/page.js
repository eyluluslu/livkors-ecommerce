...
export default async function ProductsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      {user && (
        <Link href="/cart">
          <div className="fixed top-6 right-6 z-50 group cursor-pointer">
            <div className="relative bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white p-4 rounded-2xl shadow-2xl backdrop-blur-lg border border-white/20 transform transition-all duration-300 hover:scale-110 hover:shadow-purple-500/50">
              {/* Cart Icon */}
              <div className="flex items-center justify-center">
                ...
                >
                  <path 
                    ...
                    strokeWidth={2} 
                    d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-1.5 6M7 13v6a2 2 0 002 2h6a2 2 0 002-2v-6m-8 0V9a2 2 0 012-2h4a2 2 0 012 2v4" 
                  />
                </svg>
              </div>
            ...
            {/* Floating Animation */}
            <div className="absolute inset-0 bg-gradient-to-r from-purple-400 to-pink-400 rounded-2xl animate-ping opacity-25"></div>
          </div>
        </Link>
      )}
