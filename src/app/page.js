...
import { getHeroBanners, getSiteSettings, getContactInfo } from '@/lib/site-actions'
...
export default async function HomePage() {
  ...
  // Banner, site ayarları ve iletişim bilgilerini getir
  const [banners, siteSettings, contactInfo] = await Promise.all([
    getHeroBanners().then(result => result.success ? result.data : []),
    getSiteSettings().then(result => result.success ? result.data : null),
    getContactInfo().then(result => result.success ? result.data : null)
  ])
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="lg:col-span-2">
              ...
              <div className="flex space-x-4">
                <a href={contactInfo?.facebook || '#'} className="w-12 h-12 bg-slate-800 rounded-full flex items-center justify-center text-blue-400 hover:bg-blue-900 hover:text-white transition-all duration-300">
                  📘
                </a>
                <a href={contactInfo?.instagram || '#'} className="w-12 h-12 bg-slate-800 rounded-full flex items-center justify-center text-pink-400 hover:bg-pink-900 hover:text-white transition-all duration-300">
                  📷
                </a>
                <a href={contactInfo?.twitter || '#'} className="w-12 h-12 bg-slate-800 rounded-full flex items-center justify-center text-cyan-400 hover:bg-cyan-900 hover:text-white transition-all duration-300">
                  🐦
                </a>
                <a href={contactInfo?.whatsapp || '#'} className="w-12 h-12 bg-slate-800 rounded-full flex items-center justify-center text-green-400 hover:bg-green-900 hover:text-white transition-all duration-300">
                  📱
                </a>
              </div>
            </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-center text-slate-400">
                  ...
                  <div>
                    ...
                    <div>{contactInfo?.email || 'info@livkors.com'}</div>
                  </div>
                </li>
                <li className="flex items-center text-slate-400">
                  ...
                  <div>
                    ...
                    <div>{contactInfo?.phone || '+90 212 123 45 67'}</div>
                  </div>
                </li>
                <li className="flex items-center text-slate-400">
                  ...
                  <div>
                    ...
                    <div>{contactInfo?.address || 'Beyoğlu, İstanbul'}</div>
                  </div>
                </li>
                <li className="flex items-center text-slate-400">
                  ...
                  <div>
                    ...
                    <div>{contactInfo?.workingHours || '09:00 - 18:00'}</div>
                  </div>
                </li>
              </ul>
            </div>
