      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-blue-200 mt-4">
            {aboutData?.heroSubtitle || '2004 yılından beri kaliteli çanta üretiminde öncü firma'}
          </p>
        </div>
      </section>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
            ...
            <div className="prose prose-lg max-w-none text-gray-600">
              <div className="text-lg leading-relaxed whitespace-pre-line">
                {aboutData?.storyContent || `Livkors, 2004 yılında kaliteli çanta ve aksesuar tutkunları tarafından kurulmuş, müşteri memnuniyetini her şeyin üstünde tutan bir markadır. Modern yaşamın ihtiyaçlarını karşılayan, şık ve fonksiyonel tasarımlar sunmayı misyon edinmiştir.
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-6 text-center">
              ...
              <p className="text-gray-600 text-sm">
                20 yıllık moda ve tekstil sektörü deneyimi
              </p>
            </div>
            <div className="bg-white rounded-xl shadow-lg p-6 text-center">
